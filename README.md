...
6.  The CV Manager has four core components that need to be built and run: the API, the PostgreSQL database, Keycloak, and the webapp. Ensure that both of the following profiles are specified in the COMPOSE_PROFILES variable of your .env file:
...
7.  Use the docker compose to start the required components:
...
8.  Access the website by going to http://localhost:3000
...
9.  To access keycloak go to http://localhost:8084/
